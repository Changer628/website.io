...
def collectionRetrieval(username):
    collectionXml = urlopen('https://www.boardgamegeek.com/xmlapi2/collection?username=%s&brief=1&own=1&version=1' % username)
    ...
    return collection, expansionCollection
